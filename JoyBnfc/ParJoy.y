...
L_IntegerConstant { PT _ (T_IntegerConstant $$) }
L_FloatConstant { PT _ (T_FloatConstant $$) }
...
IntegerConstant    :: { IntegerConstant} : L_IntegerConstant { IntegerConstant ($1)}
FloatConstant    :: { FloatConstant} : L_FloatConstant { FloatConstant ($1)}
